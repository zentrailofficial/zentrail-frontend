        ...
        <div className="flex items-center justify-center gap-4 sm:gap-6">
          {[-1, 0, 1].map((offset) => {
            ...
            return (
              <div
                key={index}
                className={`w-[100px] h-[110px] sm:w-[200px] sm:h-[180px] lg:w-[218px] lg:h-[200px]  rounded-[12px] relative transition-all duration-300 shadow-lg ${
                  isActive && "scale-110 "
                }`}
              >
                <div>
                  ...
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 ">
                    <p className="text-[#fff] text-center line-clamp-1">
                      {images[index]?.name}
                    </p>
                  </div>
                </div>
                {!isActive && (
                  <div className="w-full h-full cursor-pointer relative bg-[#cce5ed] opacity-65 rounded-[12px]">
                    <div className="absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2   w-14 h-14 sm:w-20 sm:h-20 rounded-[12px]  flex items-center justify-center  "></div>
                  </div>
                )}
              </div>
            );
